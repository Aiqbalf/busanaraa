...
<section class="listing-container">
  <div class="main-content">
    ...
    <div class="result-info">
      <?php 
      $jenis = $_POST['jenis'];
      $sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Anak Laki-Laki'";
    ...
    <?php 
    $sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND jenis.id_jenis='$jenis' AND baju.kategori='Anak Laki-Laki'";
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-box">
      ...
      $sql2 = "SELECT baju.*,jenis.* FROM baju,jenis 
              WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori ='Anak Laki-Laki' 
