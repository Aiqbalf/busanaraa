...
$pagedesc = "Baju Anak Perempuan - Penyewaan Baju";
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<section class="page-header">
  ...
  <div class="header-content">
    <h1>Daftar Baju Anak Perempuan</h1>
    <ul class="breadcrumb">
      <li><a href="../index.php">Home</a></li>
      <li>Daftar Baju Anak Perempuan</li>
    </ul>
  </div>
</section>
...
<section class="listing-container">
  <div class="main-content">
    ...
    <div class="result-info">
      <?php 
      $jenis = $_POST['jenis'];
      $sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Anak Perempuan'";
    ...
    $sql1 = "SELECT baju.*, jenis.* 
             FROM baju, jenis 
             WHERE baju.id_jenis = jenis.id_jenis 
             AND jenis.id_jenis = '$jenis' 
             AND baju.kategori = 'Anak Perempuan'";
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-box">
      <h4>Cari Baju</h4>
      <form action="bajuanakp_cari.php" method="post">
    ...
    <div class="sidebar-box">
      ...
      <?php
      $sql2 = "SELECT baju.*, jenis.* 
               FROM baju, jenis 
               WHERE baju.id_jenis = jenis.id_jenis 
               AND baju.kategori = 'Anak Perempuan' 
               ORDER BY baju.id_baju DESC 
               LIMIT 4";
