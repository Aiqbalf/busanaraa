...
<section class="page-header">
  ...
  <div class="header-content">
    <h1>Daftar Baju Dewasa Perempuan</h1>
    <ul class="breadcrumb">
      <li><a href="beranda.php">Home</a></li>
      <li>Daftar Baju Dewasa Perempuan</li>
    </ul>
  </div>
</section>
...
<section class="listing-container">
  <div class="main-content">
    ...
    <div class="result-info">
      <?php 
      $jenis = $_POST['jenis'];
      $sql = "SELECT * FROM baju WHERE id_jenis='$jenis' AND kategori='Dewasa Perempuan'";
    ...
    $sql1 = "SELECT baju.*, jenis.* 
             ...
             AND baju.kategori = 'Dewasa Perempuan'";
