...
<head>
    <meta charset="UTF-8">
    <title><?php echo $pagedesc; ?> - Menunggu Konfirmasi</title>
    ...
    <style>
        ...
        .page-title {
            ...
            width: 100%;
            padding-bottom: 10px;
            border-bottom: 2px solid #3498db; /* Warna berbeda untuk konfirmasi */
        }
        ...
        table th {
            background: #3498db; /* Warna merah untuk status konfirmasi */
            color: white;
            padding: 10px 8px;
            text-align: center;
            font-weight: bold;
        ...
        table tr:hover {
            background-color: #ffeaea; /* Hover warna merah muda */
        }
        ...
        .action-icons a.btn-view {
            background: #3498db;
            color: white;
        }

        .action-icons a.btn-edit {
            background: #2ecc71;
            color: white;
        }
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo IndonesiaTgl(htmlspecialchars($result['tgl_mulai'])); ?></td>
                                    <td><?php echo IndonesiaTgl(htmlspecialchars($result['tgl_selesai'])); ?></td>
                                    ...
                                    <td>
                                        <span class="status-badge"><?php echo htmlspecialchars($result['status']); ?></span>
                                    </td>
                                    <td>
                                        <div class="action-icons">
                                            <a href="javascript:void(0)" onclick="showSewaModal('<?php echo $result['kode_booking']; ?>')" class="btn-view" title="Lihat Detail">👁</a>
                                            <a href="sewaedit.php?id=<?php echo $result['kode_booking']; ?>" class="btn-edit" title="Edit">✏</a>
                                        </div>
                                    </td>
                                </tr>
                        <?php 
                        ...
                        ?>
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    <p>Tidak ada sewa yang menunggu konfirmasi</p>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
